...
class TextKeyboard(
    ...
    companion object {
        ...
        val LandscapeLayout: List<List<KeyDef>> = listOf(
            listOf(
                MultiSwipeAlphabetKey("Q", "1", "1", null, null, null, 0.075f),
                MultiSwipeAlphabetKey("W", "2", "2", null, null, null, 0.075f),
                MultiSwipeAlphabetKey("E", "3", "3", null, null, null, 0.075f),
                MultiSwipeAlphabetKey("R", "4", "4", null, null, null, 0.075f),
                MultiSwipeAlphabetKey("T", "5", "5", null, null, null, 0.075f),
                SymbolKey("1", 0.075f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("2", 0.075f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("3", 0.075f, KeyDef.Appearance.Variant.Alternative),
                MultiSwipeAlphabetKey("Y", "6", "6", null, null, null, 0.075f),
                MultiSwipeAlphabetKey("U", "7", "7", null, null, null, 0.075f),
                MultiSwipeAlphabetKey("I", "8", "8", null, null, null, 0.075f),
                MultiSwipeAlphabetKey("O", "9", "9", null, null, null, 0.075f),
                MultiSwipeAlphabetKey("P", "0", "0", null, null, null, 0.075f)
            ),
            listOf(
                MultiSwipeAlphabetKey("A", "\\", "\\", null, null, null, 0.075f),
                MultiSwipeAlphabetKey("S", "*  /", "//", null, "*", "/", 0.075f),
                MultiSwipeAlphabetKey("D", "!  =", "!=", null, "!", "=", 0.075f),
                MultiSwipeAlphabetKey("F", "&  |", "&&", "||", "&", "|", 0.075f),
                MultiSwipeAlphabetKey("G", "^  ~", null, null, "^", "~", 0.075f),
                SymbolKey("4", 0.075f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("5", 0.075f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("6", 0.075f, KeyDef.Appearance.Variant.Alternative),
                MultiSwipeAlphabetKey("H", "<  >", "<>", null, "<", ">", 0.075f),
                MultiSwipeAlphabetKey("J", "[  ]", "[]", null, "[", "]", 0.075f),
                MultiSwipeAlphabetKey("K", "{  }", "{}", null, "{", "}", 0.075f),
                MultiSwipeAlphabetKey("L", "?", "?", null, null, null)
            ),
            listOf(
                CapsKey(),
                MultiSwipeAlphabetKey("Z", "+  -", KeyAction.SelectAllAction, null, "+", "-", 0.075f),
                MultiSwipeAlphabetKey("X", "@  #", KeyAction.CutAction, null, "@", "#", 0.075f),
                MultiSwipeAlphabetKey("C", "$  %", KeyAction.CopyAction, null, "$", "%", 0.075f),
                MultiSwipeAlphabetKey("V", ":  `", KeyAction.PasteAction, null, ":", "`", 0.075f),
                MultiSwipeAlphabetKey("B", ";", ";", null, null, null, 0.075f),
                SymbolKey("7", 0.075f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("8", 0.075f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("9", 0.075f, KeyDef.Appearance.Variant.Alternative),
                MultiSwipeAlphabetKey("N", "(  )", "()", null, "(", ")", 0.075f),
                MultiSwipeAlphabetKey("M", "\"  '", "\"\"", "''", "\"", "'", 0.075f),
                BackspaceKey()
            ),
            listOf(
                LanguageKey(),
                SpaceKey(0.3f),
                CommaKey(0.075f, KeyDef.Appearance.Variant.Alternative),
                LayoutSwitchKey("!?#", PickerWindow.Key.Symbol.name, 0.075f),
                SymbolKey("0", 0.075f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey(".", 0.075f, KeyDef.Appearance.Variant.Alternative),
                SpaceKey(0.3f),
                ReturnKey(0.075f)
            )
        )

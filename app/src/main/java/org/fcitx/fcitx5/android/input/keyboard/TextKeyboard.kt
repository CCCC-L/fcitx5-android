...
class TextKeyboard(
    ...
    companion object {
        ...
        val LandscapeLayout: List<List<KeyDef>> = listOf(
            listOf(
                MultiSwipeAlphabetKey("Q", "1", "1", null, null, null, 0.07f),
                MultiSwipeAlphabetKey("W", "2", "2", null, null, null, 0.07f),
                MultiSwipeAlphabetKey("E", "3", "3", null, null, null, 0.07f),
                MultiSwipeAlphabetKey("R", "4", "4", null, null, null, 0.07f),
                MultiSwipeAlphabetKey("T", "5", "5", null, null, null, 0.07f),
                SymbolKey("1", 0.07f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("2", 0.07f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("3", 0.07f, KeyDef.Appearance.Variant.Alternative),
                MultiSwipeAlphabetKey("Y", "6", "6", null, null, null, 0.07f),
                MultiSwipeAlphabetKey("U", "7", "7", null, null, null, 0.07f),
                MultiSwipeAlphabetKey("I", "8", "8", null, null, null, 0.07f),
                MultiSwipeAlphabetKey("O", "9", "9", null, null, null, 0.07f),
                MultiSwipeAlphabetKey("P", "0", "0", null, null, null, 0.07f)
            ),
            listOf(
                MultiSwipeAlphabetKey("A", "\\", "\\", null, null, null, 0.07f),
                MultiSwipeAlphabetKey("S", "*  /", "//", null, "*", "/", 0.07f),
                MultiSwipeAlphabetKey("D", "!  =", "!=", null, "!", "=", 0.07f),
                MultiSwipeAlphabetKey("F", "&  |", "&&", "||", "&", "|", 0.07f),
                MultiSwipeAlphabetKey("G", "^  ~", null, null, "^", "~", 0.07f),
                SymbolKey("4", 0.07f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("5", 0.07f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("6", 0.07f, KeyDef.Appearance.Variant.Alternative),
                MultiSwipeAlphabetKey("H", "<  >", "<>", null, "<", ">", 0.07f),
                MultiSwipeAlphabetKey("J", "[  ]", "[]", null, "[", "]", 0.07f),
                MultiSwipeAlphabetKey("K", "{  }", "{}", null, "{", "}", 0.07f),
                MultiSwipeAlphabetKey("L", "?", "?", null, null, null)
            ),
            listOf(
                CapsKey(),
                MultiSwipeAlphabetKey("Z", "+  -", KeyAction.SelectAllAction, null, "+", "-", 0.07f),
                MultiSwipeAlphabetKey("X", "@  #", KeyAction.CutAction, null, "@", "#", 0.07f),
                MultiSwipeAlphabetKey("C", "$  %", KeyAction.CopyAction, null, "$", "%", 0.07f),
                MultiSwipeAlphabetKey("V", ":  `", KeyAction.PasteAction, null, ":", "`", 0.07f),
                MultiSwipeAlphabetKey("B", ";", ";", null, null, null, 0.07f),
                SymbolKey("7", 0.07f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("8", 0.07f, KeyDef.Appearance.Variant.Alternative),
                SymbolKey("9", 0.07f, KeyDef.Appearance.Variant.Alternative),
                MultiSwipeAlphabetKey("N", "(  )", "()", null, "(", ")", 0.07f),
                MultiSwipeAlphabetKey("M", "\"  '", "\"\"", "''", "\"", "'", 0.07f),
                BackspaceKey()
            ),
            listOf(
                CommaKey(0.07f, KeyDef.Appearance.Variant.Alternative),
                SpaceKey(0.3f),
                LanguageKey(),
